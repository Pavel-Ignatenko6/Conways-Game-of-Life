    ...
    return (
      <div className="controls-container">
        <div className="generation-number flex-container">
          <svg className="single-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        <div className="main-controls flex-container">
          ...
          <svg className="play-icon controls-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z" />
          </svg>
          <svg className="next-icon controls-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path d="M52.5 440.6c-9.5 7.9-22.8 9.7-34.1 4.4S0 428.4 0 416V96C0 83.6 7.2 72.3 18.4 67s24.5-3.6 34.1 4.4L224 214.3V256v41.7L52.5 440.6zM256 352V256 128 96c0-12.4 7.2-23.7 18.4-29s24.5-3.6 34.1 4.4l192 160c7.3 6.1 11.5 15.1 11.5 24.6s-4.2 18.5-11.5 24.6l-192 160c-9.5 7.9-22.8 9.7-34.1 4.4s-18.4-16.6-18.4-29V352z" />
          </svg>
        </div>
        {/* slider controls */}
        <div className="slider-controls flex-container">
          ...
          <div className="single-slider">
            <svg className='single-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
